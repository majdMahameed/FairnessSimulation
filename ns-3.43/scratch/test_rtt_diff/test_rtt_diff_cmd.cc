...
NS_LOG_COMPONENT_DEFINE("TestRTTDifference"); // define logging component so NS_LOG_* macros work
...
int main(int argc, char *argv[]) {
    ...
    std::string dataSendRate = "4Mbps"; // default data rate
    std::string rttDelays = "10ms"; // default: all flows get 10ms
    std::string bottleneckLinkDataRate = "4Mbps"; // default bottleneck link data rate
    ...
    std::string cwndFile = "scratch/test_rtt_diff/results/cwnd_trace.csv";
    ...
    std::string summaryFile = "scratch/test_rtt_diff/results/results_summary.csv";
