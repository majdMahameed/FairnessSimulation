...
int main(int argc, char *argv[]) {
    ...
    std::string dataSendRate = "3.5Mbps"; // default data rate
    ...
    if (!useRed) {
        bottleneckLink.SetQueue("ns3::DropTailQueue", "MaxSize", StringValue("420p")); // DropTail for all except DCTCP
    }
    ...
    if (useRed) {
        ...
        Config::SetDefault("ns3::RedQueueDisc::MinTh", DoubleValue(490)); // packets
        Config::SetDefault("ns3::RedQueueDisc::MaxTh", DoubleValue(550)); // packets
        Config::SetDefault("ns3::RedQueueDisc::MaxSize", QueueSizeValue(QueueSize("800p")));
    ...
    std::string cwndFile = "scratch/test_rtt_diff_6/results/cwnd_trace.csv";
    ...
    std::string summaryFile = "scratch/test_rtt_diff_6/results/results_summary.csv";
