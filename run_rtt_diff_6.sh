...
RTT_DELAYS="10ms,20ms,30ms,40ms,50ms"
# change this if your ns-3 run command differs
NS3_RUN_CMD="./ns3 run scratch/test_rtt_diff_6/test_rtt_diff_cmd.cc -- --TcpProtocol="

RESULT_DIR="scratch/test_rtt_diff_6/results"
mkdir -p "$RESULT_DIR"
